...
GPS_Concat('/Users/wheelergans/Desktop/untitled folder')
#ts_log = pd.read_csv('ts_log.csv')
WS_data = pd.read_csv('gps_log.csv')
WS_data.index = WS_data.GPS_Epoch_Time
WS_data = WS_data[WS_data['GPS_Epoch_Time'] >1462995752]
WS_data[['Vert_Vel_(mm/s)','SOG_(mm/s)']].plot()
